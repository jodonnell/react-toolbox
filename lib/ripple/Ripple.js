    ...
    var RippledComponent = function (_Component) {
      ...
      function RippledComponent() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RippledComponent.__proto__ || Object.getPrototypeOf(RippledComponent)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
          ...
          var _ReactDOM$findDOMNode = _reactDom2.default.findDOMNode(_this).getBoundingClientRect(),
          ...
          if (_this.doRipple()) {
            _this.animateRipple(centerX, centerY, false);
          }
      ...
      _createClass(RippledComponent, [{
        ...
        value: function getDescriptor(x, y) {
          var _ReactDOM$findDOMNode2 = _reactDom2.default.findDOMNode(this).getBoundingClientRect(),
              left = _ReactDOM$findDOMNode2.left,
              top = _ReactDOM$findDOMNode2.top,
              height = _ReactDOM$findDOMNode2.height,
              width = _ReactDOM$findDOMNode2.width;
        ...
        value: function addRippleDeactivateEventListener(isTouch, rippleKey) {
          ...
          var endRippleKeyUp = this.createRippleDeactivateCallback('keyup', rippleKey);

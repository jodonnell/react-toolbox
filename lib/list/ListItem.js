    ...
    _createClass(ListItem, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          'li',
          { tabIndex: '0', className: theme.listItem + ' ' + className, onClick: this.handleClick, onMouseDown: onMouseDown, onTouchStart: onTouchStart, onKeyDown: this.handleEnterPress },

...
var factory = function factory(Tab, TabContent, FontIcon) {
  ...
  var Tabs = function (_Component) {
    ...
    _createClass(Tabs, [{
      ...
      key: 'getNewIndex',
      value: function getNewIndex(headers, delta) {
        var newIndex = (this.props.index + delta) % headers.length;
      ...
      value: function handleArrowPress(headers) {
        var _this3 = this;

        return function (event) {
          if (event.key === 'ArrowRight') {
            _this3.handleHeaderClick(_this3.getNewIndex(headers, 1));
        ...
        return headers.map(function (item, idx) {
          return _react2.default.cloneElement(item, {
            ...
            onClick: function onClick(event, index) {
              _this4.handleHeaderClick(index);
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: theme.navigationContainer, onKeyDown: this.handleArrowPress(headers) },
